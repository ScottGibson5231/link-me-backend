...
public class OCRCallout
{
    ...
    public static async Task<HttpResponseMessage> Send(IFormFile file)
    {
        ...
        try
        {
            ...
            form.Add(new StringContent(Environment.GetEnvironmentVariable("OCR_API_KEY")), "apikey"); //Added api key in form data
